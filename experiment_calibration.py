from pp.meta_regressors import train_random_forest_regressor, evaluate_regressor_against_calibration_baseline
...
for model_to_evaluate in models_to_evaluate:
    experiment_name = 'calibration_correct_shift__missing'
    ...
    evaluate_regressor_against_calibration_baseline(test_data, y_test, target_data, y_target, test_perturbations, model,
                                                    performance_predictor, scoring, scoring_name, dataset_name,
                                                    'missing', learner_name, experiment_name, 'sigmoid')
